...
# VLM text-to-image attention visualization for finetuned checkpoints.
...
OUT_DIR=/home/karthus_chen/ycb_ws/GR00T-N1/eval/GR00T_N1d7_100k_g1_wbc_pick_up_multiple_cushions_brainco_200/vl_eval
mkdir -p "${OUT_DIR}"

...
class UnitreeG1WBCDataConfig(BaseDataConfig):
    video_keys = [
...
class UnitreeG1UpperRightArmDataConfig(BaseDataConfig):
    video_keys = [
        "video.head_stereo_left",
        "video.head_stereo_right",
        "video.wrist_right",
    ...
    state_keys = [
        "state.right_hand",
        "state.robot_q_waist",
        "state.robot_q_right_arm",
    ]
    action_keys = [
        "action.right_hand",
        "action.robot_q_waist",
        "action.robot_q_right_arm",
    ]
    language_keys = ["annotation.human.task_description"]
    observation_indices = [0] # or [0, 1]
    action_indices = list(range(16))
...
DATA_CONFIG_MAP = {
    ...
    "unitree_g1_upper_body": UnitreeG1UpperBodyDataConfig(),
    "unitree_g1_upper_right_arm": UnitreeG1UpperRightArmDataConfig(),
}
